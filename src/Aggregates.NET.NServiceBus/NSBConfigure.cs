    ...
    public static class NSBConfigure
    {
        public static Configure NServiceBus(this Configure config, EndpointConfiguration endpointConfig)
        {
...

            {
                ...
                endpointConfig.UseSerialization<AggregatesSerializer>();
            ...
            config.RegistrationTasks.Add(c =>
            {
                ...
                container.Register(factory => new Internal.DelayedRetry(factory.Resolve<IMetrics>(), factory.Resolve<IMessageDispatcher>()), Lifestyle.Singleton);
                ...
                startableEndpoint = EndpointWithExternallyManagedContainer.Create(endpointConfig, new ContainerAdapter());
            ...
            {
                return Bus.Start(startableEndpoint);
            });
